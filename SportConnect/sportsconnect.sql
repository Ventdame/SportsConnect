...
--
-- Hôte : localhost
-- Généré le : ven. 17 jan. 2025 à 16:11
...
(1, 'Tournoi de Tennis', '2024-12-30 14:00:00', 2, 1, 'Grand tournoi pour amateurs et professionnels', 1, 50.00, 1),
(2, 'Match de Football', '2025-01-10 18:00:00', 1, 2, 'Match amical ouvert à tous', 0, 25.00, 2),
(3, 'Initiation au Padel', '2024-12-28 10:00:00', 4, 3, 'Venez découvrir les bases du padel', 1, 15.00, 3),
(4, 'Compétition de Basketball', '2025-01-15 20:00:00', 3, 4, 'Tournoi pour équipes amateurs', 0, 30.00, 4),
(5, 'Tournoi de Football', '2025-01-15 15:00:00', 1, 1, 'Tournoi pour amateurs et professionnels', 0, 30.00, 1),
...
(28, 'Tournois foot', '2026-09-18 00:00:00', 1, 11, 'Tournois de foot en plein air', 1, 100.00, 32),
(22, 'tessss', '2025-01-16 00:00:00', 10, 0, 'rzqq', 1, 100.00, 32);
...
--
-- Déchargement des données de la table `participants_evenement`
--

INSERT INTO `participants_evenement` (`id_participant`, `id_evenement`, `id_utilisateur`, `statut`) VALUES
(59, 24, 41, 'en attente'),
(55, 5, 41, 'en attente'),
(58, 23, 32, 'en attente'),
(70, 2, 42, 'en attente'),
...
--
ALTER TABLE `evenements`
  MODIFY `id_evenement` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `participants_evenement`
  MODIFY `id_participant` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
...
--
ALTER TABLE `utilisateurs`
  MODIFY `id_utilisateur` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
COMMIT;
